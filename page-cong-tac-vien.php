...
<div id="mini-action" class="callToAction">
    <div style="text-align:center; font-size:20px; cursor:pointer"><i class="fa fa-comments" aria-hidden="true"></i> Liên hệ với chúng tôi để biết thêm thông tin 
        <b>
            <?php
                $phone = get_field( 'phone-number' );  
                if( $phone ) { // kiểm tra xem nó có dữ liệu hay không
                    echo  $phone;
                }
            ?>
        </b>
